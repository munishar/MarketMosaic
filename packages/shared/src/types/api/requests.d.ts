...
export interface UpdateLineOfBusinessRequest extends Partial<CreateLineOfBusinessRequest> {
}
...
export interface UpdateFormPaperRequest extends Partial<CreateFormPaperRequest> {
}
...
export interface UpdateCapacityRequest extends Partial<CreateCapacityRequest> {
}
...
export interface UpdateNetworkRelationshipRequest extends Partial<CreateNetworkRelationshipRequest> {
}
...
export interface UpdateSyncScheduleRequest extends Partial<CreateSyncScheduleRequest> {
    is_active?: boolean;
}
...
export interface UpdateAMSConnectionRequest extends Partial<CreateAMSConnectionRequest> {
    is_active?: boolean;
}

 ...
 */
export function calculateAvailableCapacity(maxLimit, deployedCapacity) {
 ...
 */
export function calculateCapacityUtilization(maxLimit, deployedCapacity) {
    const max = parseFloat(String(maxLimit ?? '0')) || 0;
    if (max === 0)
        return 0;
    const deployed = parseFloat(String(deployedCapacity ?? '0')) || 0;
 ...
 */
export function getCapacityStatus(maxLimit, deployedCapacity) {

...
VALUES
  ('b0000000-0000-0000-0000-000000000001', 'admin@brokerflow.com', '$2a$10$rQEY0tn5pFqKmDVmSEHPOODnEWwRVdLsFnAafBSwhtne0QLsZbMGy', 'Admin', 'User', 'admin', 'a0000000-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
